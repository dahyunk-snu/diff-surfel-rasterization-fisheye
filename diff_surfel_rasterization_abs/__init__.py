...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, depth, radii, contrib_sum, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(*args)
        ...
        return color, radii, depth, contrib_sum

    @staticmethod
    def backward(ctx, grad_out_color, grad_radii, grad_depth, grad_contrib_sum):
